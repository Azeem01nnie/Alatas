...
function downloadContractPdf(transaction) {
  ...
  const rentalY = drawColumn(col3X, 'RENTAL DETAILS', [
    ...
    ['From', formatDateTime(rental.periodFrom)],
    ['To', formatDateTime(rental.periodTo)],
  ...
  const intro = `This agreement was acknowledged by ${name} for the rental of ${vehicle.make || ''} ${vehicle.series || ''} (${vehicle.plateNo || ''}) covering ${formatDateTime(rental.periodFrom)} to ${formatDateTime(rental.periodTo)}.`
    ...
    <section className="transaction-page">
      ...
      <div className="transaction-grid">
        ...
        <article className="transaction-card">
          ...
          <dl className="transaction-dl">
            ...
            <div>
              <dt>From</dt>
              <dd>{formatDateTime(rental.periodFrom)}</dd>
            </div>
            <div>
              <dt>To</dt>
              <dd>{formatDateTime(rental.periodTo)}</dd>
            </div>
            <div>
              <dt>Rental Fee</dt>
      ...
      <article className="transaction-contract">
        ...
        <p className="contract-intro">
          ...
          ({vehicle.plateNo}) covering {formatDateTime(rental.periodFrom)} to{' '}
