...
export default function AdminPanel({ onBack }) {
  ...
  const requestStartRental = (vehicle, scheduled) => {
    const startLabel = scheduled?.rental?.periodFrom
                    ...
                    <div className="admin-vehicle-meta">
                      ...
                      {scheduled && (
                        <span className="scheduled-hint">
                          Scheduled {new Date(scheduled.rental?.periodFrom).toLocaleString()}
                        </span>
                      )}
                    </div>
                    <span
                ...
                {historyWithImages.map((r) => (
                  ...
                  >
                    ...
                    <div className="history-meta">
                      ...
                      <span>
                        {formatDateTime(r.rental?.periodFrom)} →{' '}
                        {formatDateTime(r.rental?.periodTo)}
                      </span>
